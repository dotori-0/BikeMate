...
class HealthData {
    ...
    static var shareDataTypes: [HKSampleType] {
        return allHealthDataTypesExceptAppleExerciseTime
    }
    ...
    private static var allHealthDataTypesExceptAppleExerciseTime: [HKSampleType] {
        let typeIdentifiers: [String] = [
            HKQuantityTypeIdentifier.distanceCycling.rawValue,
        ]
    ...
    class func requestHealthDataAccessIfNeeded(dataTypes: [String]? = nil, completion: @escaping (_ success: Bool) -> Void) {
        ...
        var shareDataTypes = Set(allHealthDataTypesExceptAppleExerciseTime)
    ...
    class func fetchStatistics(with identifier: HKQuantityTypeIdentifier,
        ...
        guard let quantityType = HKObjectType.quantityType(forIdentifier: identifier) else {
            fatalError("*** Unable to create a distance cycling type ***")
        }
